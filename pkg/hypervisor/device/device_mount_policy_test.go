...
const singleTemplateProviderConfig = "" +
	`{"hardwareMetadata":[{"model":"A100_SXM_80G","fullModelName":"NVIDIA A100-SXM4-80GB",` +
	`"partitionTemplateRefs":["19"]}],"virtualizationTemplates":[{"id":"19","name":"1g.10gb"}]}`
...
func TestSplitDeviceUsesProviderTemplateIDForNvidia(t *testing.T) {
	...
	if err := os.Setenv(constants.TFProviderTemplateConfigEnv, singleTemplateProviderConfig); err != nil {
