...
func (in *DevicePluginDetectionConfig) DeepCopyInto(out *DevicePluginDetectionConfig) {
	*out = *in
	if in.ResourceNamePrefixes != nil {
		in, out := &in.ResourceNamePrefixes, &out.ResourceNamePrefixes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *DevicePluginDetectionConfig) DeepCopy() *DevicePluginDetectionConfig {
	...
	out := new(DevicePluginDetectionConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUNvLinkPeer) DeepCopyInto(out *GPUNvLinkPeer) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUNvLinkPeer.
func (in *GPUNvLinkPeer) DeepCopy() *GPUNvLinkPeer {
	if in == nil {
		return nil
	}
	out := new(GPUNvLinkPeer)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUNvLinkStatus) DeepCopyInto(out *GPUNvLinkStatus) {
	*out = *in
	if in.Peers != nil {
		in, out := &in.Peers, &out.Peers
		*out = make([]GPUNvLinkPeer, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUNvLinkStatus.
func (in *GPUNvLinkStatus) DeepCopy() *GPUNvLinkStatus {
	if in == nil {
		return nil
	}
	out := new(GPUNvLinkStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUPeerLinkStatus) DeepCopyInto(out *GPUPeerLinkStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUPeerLinkStatus.
func (in *GPUPeerLinkStatus) DeepCopy() *GPUPeerLinkStatus {
	if in == nil {
		return nil
	}
	out := new(GPUPeerLinkStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUTopologyStatus) DeepCopyInto(out *GPUTopologyStatus) {
	*out = *in
	if in.Peers != nil {
		in, out := &in.Peers, &out.Peers
		*out = make([]GPUPeerLinkStatus, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUTopologyStatus.
func (in *GPUTopologyStatus) DeepCopy() *GPUTopologyStatus {
	if in == nil {
		return nil
	}
	out := new(GPUTopologyStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GangSchedulingStatus) DeepCopyInto(out *GangSchedulingStatus) {
	clone := in.DeepCopy()
	*out = *clone
}
...
func (in *HardwareModelInfo) DeepCopyInto(out *HardwareModelInfo) {
	*out = *in
	out.Fp16TFlops = in.Fp16TFlops.DeepCopy()
	if in.TotalExtendedResources != nil {
		in, out := &in.TotalExtendedResources, &out.TotalExtendedResources
		*out = make(map[string]uint32, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.PartitionTemplateRefs != nil {
		in, out := &in.PartitionTemplateRefs, &out.PartitionTemplateRefs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.DeviceMount != nil {
		in, out := &in.DeviceMount, &out.DeviceMount
		*out = new(ProviderDeviceMountConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeDefragConfig) DeepCopyInto(out *NodeDefragConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeDefragConfig.
func (in *NodeDefragConfig) DeepCopy() *NodeDefragConfig {
	if in == nil {
		return nil
	}
	out := new(NodeDefragConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeIsolationModeRule) DeepCopyInto(out *NodeIsolationModeRule) {
	*out = *in
	in.Selector.DeepCopyInto(&out.Selector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeIsolationModeRule.
func (in *NodeIsolationModeRule) DeepCopy() *NodeIsolationModeRule {
	if in == nil {
		return nil
	}
	out := new(NodeIsolationModeRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeManagerConfig) DeepCopyInto(out *NodeManagerConfig) {
	*out = *in
	if in.IsolationModeRules != nil {
		in, out := &in.IsolationModeRules, &out.IsolationModeRules
		*out = make([]NodeIsolationModeRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ProviderConfigSpec) DeepCopyInto(out *ProviderConfigSpec) {
	*out = *in
	...
	if in.Hypervisor != nil {
		in, out := &in.Hypervisor, &out.Hypervisor
		*out = new(ProviderHypervisorConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.HardwareMetadata != nil {
		in, out := &in.HardwareMetadata, &out.HardwareMetadata
		*out = make([]HardwareModelInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.VirtualizationTemplates != nil {
		in, out := &in.VirtualizationTemplates, &out.VirtualizationTemplates
		*out = make([]VirtualizationTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.InUseResourceNames != nil {
		in, out := &in.InUseResourceNames, &out.InUseResourceNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.DevicePluginDetection != nil {
		in, out := &in.DevicePluginDetection, &out.DevicePluginDetection
		*out = new(DevicePluginDetectionConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProviderDeviceMountConfig) DeepCopyInto(out *ProviderDeviceMountConfig) {
	*out = *in
	if in.SharedDevices != nil {
		in, out := &in.SharedDevices, &out.SharedDevices
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProviderDeviceMountConfig.
func (in *ProviderDeviceMountConfig) DeepCopy() *ProviderDeviceMountConfig {
	if in == nil {
		return nil
	}
	out := new(ProviderDeviceMountConfig)
...
func (in *ProviderHypervisorConfig) DeepCopyInto(out *ProviderHypervisorConfig) {
	*out = *in
	if in.ExtraEnv != nil {
		...
		*out = make([]ProviderHypervisorEnvVar, len(*in))
		copy(*out, *in)
	}
	if in.HostPathMounts != nil {
		in, out := &in.HostPathMounts, &out.HostPathMounts
		*out = make([]ProviderHypervisorHostPathMount, len(*in))
		copy(*out, *in)
	}
	if in.DeviceMount != nil {
		in, out := &in.DeviceMount, &out.DeviceMount
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProviderHypervisorEnvVar) DeepCopyInto(out *ProviderHypervisorEnvVar) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProviderHypervisorEnvVar.
func (in *ProviderHypervisorEnvVar) DeepCopy() *ProviderHypervisorEnvVar {
	if in == nil {
		return nil
	}
	out := new(ProviderHypervisorEnvVar)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProviderHypervisorHostPathMount) DeepCopy() *ProviderHypervisorHostPathMount {
	...
	out := new(ProviderHypervisorHostPathMount)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualizationTemplate) DeepCopyInto(out *VirtualizationTemplate) {
	*out = *in
	if in.NVMLProfileID != nil {
		in, out := &in.NVMLProfileID, &out.NVMLProfileID
		*out = new(uint32)
		**out = **in
	}
	if in.PlacementLimit != nil {
		in, out := &in.PlacementLimit, &out.PlacementLimit
...
func (in *VirtualizationTemplate) DeepCopy() *VirtualizationTemplate {
	...
	out := new(VirtualizationTemplate)
	in.DeepCopyInto(out)
	return out
}
